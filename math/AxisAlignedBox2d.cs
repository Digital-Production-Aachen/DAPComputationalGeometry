...
namespace g3
{
    public struct AxisAlignedBox2d
    {
        ...
        public void Contain(ReadOnlySpan<Vector2d> points)
        {
        ...
        public bool ContainsInclusive(in Vector2d v, double tolerance = MathUtil.ZeroTolerance)
        {
            return (Min.x <= v.x + tolerance) && (Min.y < v.y + tolerance) && (Max.x > v.x - tolerance) && (Max.y > v.y - tolerance);
        }
        ...
        public bool ContainsInclusive(in AxisAlignedBox2d box2, double tolerance = MathUtil.ZeroTolerance)
        {
            return ContainsInclusive(box2.Min, tolerance) && ContainsInclusive(box2.Max, tolerance);
        }

        public bool Intersects(AxisAlignedBox2d box) => Intersects(ref box);
        ...
        public bool Intersects(Segment2d segment) => segment.Bounds.Intersects(this);
